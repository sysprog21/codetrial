...
async function checkEditorNewlines(page) {
  ...
  const cases = [
    ...
    { name: "cross-line block comment", language: "C++", value: "/*\n * setup {\n */", start: 13, expected: "/*\n * setup {\n \n */", caret: 15 },
    { name: "closing cross-line comment", language: "C++", value: "/*\n    */ if (ready) {}", start: 22, expected: "/*\n    */ if (ready) {\n        \n    }", caret: 31 },
    { name: "closed comment before line comment", language: "C++", value: "/*\n    */ // {", expected: "/*\n    */ // {\n    " },
    { name: "JavaScript multiline template contains block opener", language: "JavaScript", value: 'const text = `\n/*\n`;\n    if (ready) {', expected: 'const text = `\n/*\n`;\n    if (ready) {\n        ' },
    { name: "JavaScript regex contains block opener", language: "JavaScript", value: String.raw`const re = /\/*/;` + "\n    if (ready) {", expected: String.raw`const re = /\/*/;` + "\n    if (ready) {\n        " },
    { name: "C++ raw string contains block opener", language: "C++", value: 'auto text = R"tag(\n/*\n)tag";\n    if (ready) {', expected: 'auto text = R"tag(\n/*\n)tag";\n    if (ready) {\n        ' },
    { name: "Java text block contains block opener", language: "Java", value: 'String text = """\n/*\n""";\n    if (ready) {', expected: 'String text = """\n/*\n""";\n    if (ready) {\n        ' },
    { name: "Python ignores block comment syntax", language: "Python 3", value: "/*\n    if ready:", expected: "/*\n    if ready:\n        " },
