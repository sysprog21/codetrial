...
test("the report card this page renders names no finding either", () => {
  ...
  assert.deepEqual(
    ...
    new Set([
      ...
      "Legacy/unversioned", "NO", "No", "Practice", "REACTO/STAR", "Scenario", "Spaced",
      "Strengths", "Success:", "Test", "This", "What", "Your", "above.", "algorithm", "an",
      "and", "are", "attempt", "back", "back,", "back:", "be", "behavioral", "bring", "bundle",
      ...
      "final", "for", "formative", "happened", "held", "high", "hints", "hiring", "how", "impact",
      "interview", "interviewer", "is", "it", "kept,", "ladder", "listed", "lobby", "malformed",
      "min", "more", "much", "next", "not", "observed", "of", "offers", "only", "or", "packet",
